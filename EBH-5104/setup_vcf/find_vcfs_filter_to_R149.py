...
def main() -> None:
    ...
    R149_samples = pd.read_csv("R149_panel_samples_VCFs_no_dups_no_control.tsv", sep="\t")
    samples_to_keep = R149_samples["sample"].to_list()
    temp_df = df_no_dups_no_control[df_no_dups_no_control["sample"].isin(samples_to_keep)]

    df_no_dups_no_control = temp_df
