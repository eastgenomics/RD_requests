...
File: v1.0.0_R45.1_CNV_vep_b38.bed to be updated to ----> v1.0.1_R45.1_CNV_vep_b38.bed ......
New bed panel file path,  /home/dnanexus/new_static_beds/v1.0.1_R45.1_CNV_vep_b38.bed saved 
File: v1.0.0_R45.1_SNV_athena_b38.bed to be updated to ----> v1.0.1_R45.1_SNV_athena_b38.bed ......
New bed panel file path,  /home/dnanexus/new_static_beds/v1.0.1_R45.1_SNV_athena_b38.bed saved 
...
$ diff -s v1.0.0_SNV_test_1.bed v1.0.1_SNV_test_1.bed >> 20251111_difference_between_old_and_new_static_bed_panel_test_1.txt 
$ grep ">" 20251111_difference_between_old_and_new_static_bed_panel_test_1.txt | wc -l
4

$ cat v1.0.0_SNV_test_1.bed
...
# test case for more than one difference in a static bed - shows count of 6 which is expected the 5th case has 2 differences
 ...
 $ echo -e "#assembly=GRCh38,version=v1.0.1\n4\t40301176\t40301396\tNM_001092.4\n4\t40301800\t40301994\tNM_001002.4\n6\t40303336\t403075333\tNM_001852.2" > v1.0.1_SNV_test_2.bed
 $ diff -s v1.0.0_SNV_test_2.bed v1.0.1_SNV_test_2.bed >> 20251111_difference_between_old_and_new_static_bed_panel_test_2.txt 
$ grep ">" 20251111_difference_between_old_and_new_static_bed_panel_test_2.txt | wc -l
6


$ cat v1.0.0_SNV_test_2.bed 
4       40301176        40301396        NM_001092.4
4       40301800        40301994        NM_001002.4
6       40303336        403053333       NM_001852.2
$ cat v1.0.1_SNV_test_2.bed 
#assembly=GRCh38,version=v1.0.1
4       40301176        40301396        NM_001092.4
4       40301800        40301994        NM_001002.4
